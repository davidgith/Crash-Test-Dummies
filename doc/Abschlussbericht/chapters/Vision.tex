...
\subparagraph{Schritt 5}: Anschließend werden die Übereinstimmungen gefiltert, so dass wir nur noch die besten Übereinstimmungen haben. Dazu verwenden wir den Lowe's-Ratio-Test \cite{lowe2004distinctive}, dieser schaut sich die Distanz zwischen dem Keypoint des Referenzbildes und dem des Kamerabild an und filtert Übereinstimmungen aus, welche den Vorgegebenen Threshold nicht erfüllen. Mit Distanz ist hier keine physikalische Distanz gemeint, sondern die Euklidische Distanz von zwei Keypoint-Vektoren. Dieser gibt den Wert der Ähnlichkeit an.
