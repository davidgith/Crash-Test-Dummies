...
Für einen Spurwechsel ist das Bild der Kinect besonders in Kurven zu schmal, daher wird hier die mittlere Fahrbahnmarkierung genutzt. Hier wird das Bild nach rosafarbenen Punkten gefiltert. Da die mittlere Linie jedoch nicht durchgängig verläuft, wird durch das folgende Verfahren digital eine durchgängige Markierung erzeugt. Zuerst wird der unterste rosa Punkt erfasst und in p\textsubscript{0} abgespeichert.
\begin{align}
\label{eq:quer}	
